    ...
    <body>
        ...
        <div>
            ...
            {!! Form::open(['url' => '/Users_Create', 'method' => 'post']) !!}
                ...
                <label id="First_Label" for="First_Name">Prénom de l'Utilisateur : </label>
                <input type="text" name="First_Name" id="First_Name" required/> <br>
     
                <label id="Last_Label" for="Last_Name">Nom de l'Utilisateur : </label>
                ...
                <input type="hidden" name="UpUser_type" id="UpUser_type" required/> <br>
